...
const Hero = () => {
  ...
  return (
    <div className="bg-investment-navy text-white min-h-[80vh] flex items-center relative">
          ...
          <div className="animate-fade-in space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button 
                ...
                onClick={() => document.getElementById('property-details')?.scrollIntoView({ behavior: 'smooth' })}
              >
                Узнать детали
              </Button>
            </div>
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-xl shadow-xl">
              <div className="flex justify-between items-center pb-4 border-b border-white border-opacity-20">
                <div>
                  ...
                  <p className="text-3xl font-bold text-investment-gold">41 900 ₽</p>
                </div>
                <div>
